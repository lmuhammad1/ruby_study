# lines print one line to the screen
...
# string assigned to variable endx
end1 = "C"
end2 = "h"
end3 = "e"
end4 = "e"
...
# print outputs string on the same line (without new line)
print end1 + end2 + end3 + end4 + end5 + end6
print end7 + end8 + end9 + end10 + end11 + end12

# this just is polite use of the terminal, try removing it
# puts outputs string on a new line
